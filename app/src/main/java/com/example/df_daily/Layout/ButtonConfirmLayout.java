...
import com.example.df_daily.Service.CopyService;
...
public class ButtonConfirmLayout extends RelativeLayout{
    ...
    public ButtonConfirmLayout(Context context) {
        super(context);
    }
    CopyService.SaveBinder mBinder=null;
    ...
    public class SaveServiceCon implements ServiceConnection{
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            mBinder=(CopyService.SaveBinder)iBinder;
        }
